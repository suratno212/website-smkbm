        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="<?= base_url('jadwal-ujian') ?>">Jadwal</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="col-lg-10">
                    <div class="card">
                        <div class="card-header text-center">
                            ...
                            <p class="mb-0 mt-2">Jadwal ujian terbaru SMK Bhakti Mulya BNS</p>
                        </div>
                        <div class="card-body">
                            <?php if (empty($pengumuman)) : ?>
                                <div class="text-center py-5">
                                    <i class="fas fa-calendar-times fa-4x text-muted mb-3"></i>
                                    <h4 class="text-muted">Belum ada jadwal ujian</h4>
                                    <p class="text-muted">Jadwal ujian akan muncul di sini ketika admin mempublikasikannya</p>
                                </div>
                            <?php else : ?>
                                        ...
                                        <div class="d-flex justify-content-between align-items-start">
                                            <div class="flex-grow-1">
                                                ...
                                                <div class="d-flex justify-content-between align-items-center">
                                                    ...
                                                    <?php if ($p['file']) : ?>
                                                        <a href="<?= base_url('download-pengumuman/' . $p['id']) ?>" class="btn btn-danger">
                                                            <i class="fas fa-download me-1"></i> Download Jadwal Ujian
                                                        </a>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
