                        ...
                        <div class="card-body">
                            ...
                            <form action="<?= base_url('admin/users/update/' . $user['id']) ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="username" id="username" class="form-control <?= session('errors.username') ? 'is-invalid' : '' ?>" value="<?= old('username', isset($user['username']) ? $user['username'] : '') ?>" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php if (isset($user['foto']) && $user['foto']) : ?>
                                        <div class="mb-2">
                                            <img src="<?= base_url('uploads/profile/' . $user['foto']) ?>" alt="Profile" class="img-thumbnail" style="width: 100px;">
                                        </div>
                                    <?php endif; ?>
