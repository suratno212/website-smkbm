...
<body>
    ...
    <div class="sidebar" id="sidebar">
        <div class="sidebar-header">
            ...
            <h3>SPMB Calon Siswa</h3>
        </div>
        <div class="sidebar-menu">
            <a href="<?= base_url('calonsiswa/dashboard') ?>" class="menu-item <?= uri_string() == 'calonsiswa/dashboard' ? 'active' : '' ?>">
                <i class="fas fa-tachometer-alt"></i>
                <span>Dashboard</span>
            </a>
            <a href="<?= base_url('spmbtes/mulai') ?>" class="menu-item <?= strpos(uri_string(), 'spmbtes/mulai') === 0 ? 'active' : '' ?>">
                <i class="fas fa-edit"></i>
                <span>Mulai Tes</span>
            </a>
            <a href="<?= base_url('spmbtes/hasil') ?>" class="menu-item <?= strpos(uri_string(), 'spmbtes/hasil') === 0 ? 'active' : '' ?>">
                <i class="fas fa-chart-bar"></i>
                <span>Hasil Tes</span>
            </a>
            <a href="<?= base_url('spmb/pengumuman') ?>" class="menu-item <?= strpos(uri_string(), 'spmb/pengumuman') === 0 ? 'active' : '' ?>">
    ...
    <div class="main-content" id="mainContent">
        <div class="top-bar">
            ...
            <div class="user-info dropdown">
                ...
                <?php endif; ?>
                <div>
                    <h6 class="mb-0"><?= $calon_siswa['nama'] ?? $user['nama'] ?? $user['username'] ?? 'Calon Siswa' ?></h6>
