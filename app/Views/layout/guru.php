...
if (!isset($user)) {
    ...
    $user = (new \App\Models\UserModel())->find($user_id);
}
?>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar-menu">
            <a href="<?= base_url('guru/dashboard') ?>" class="menu-item <?= uri_string() == 'guru/dashboard' ? 'active' : '' ?>">
                <i class="fas fa-tachometer-alt"></i>
                <span>Dashboard</span>
            </a>
            <a href="<?= base_url('guru/absensi') ?>" target="_self" class="menu-item <?= (strpos(uri_string(), 'guru/absensi') === 0 && strpos(uri_string(), 'guru/absensi-guru') === false) ? 'active' : '' ?>">
                <i class="fas fa-clipboard-list"></i>
                <span>Absensi</span>
            </a>
            <a href="<?= base_url('guru/absensi-guru') ?>" class="menu-item <?= strpos(uri_string(), 'guru/absensi-guru') === 0 ? 'active' : '' ?>">
                <i class="fas fa-user-check"></i>
                <span>Absensi Guru</span>
            </a>
            <a href="<?= base_url('guru/nilai') ?>" class="menu-item <?= strpos(uri_string(), 'guru/nilai') === 0 ? 'active' : '' ?>">
                <i class="fas fa-chart-line"></i>
                <span>Kelola Nilai</span>
            </a>
            <a href="<?= base_url('guru/raport') ?>" class="menu-item <?= strpos(uri_string(), 'guru/raport') === 0 ? 'active' : '' ?>">
                <i class="fas fa-file-alt"></i>
                <span>e-Raport</span>
            </a>
            <a href="<?= base_url('guru/materitugas') ?>" class="menu-item <?= strpos(uri_string(), 'guru/materitugas') === 0 ? 'active' : '' ?>">
