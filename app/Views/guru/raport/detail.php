...
<div class="container-fluid">
    ...
    <div class="card mb-3">
        <div class="card-body">
            ...
            <strong>NIS:</strong> <?= esc($siswa['nis']) ?><br>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    foreach ($kelompokMapel as $kode => $kelompok): ?>
                        ...
                        <?php $jumlahKelompok[$kode] = 0;
                        foreach ($kelompok['sub'] as $namaMapel): ?>
                            <?php
                            $mapelObj = null;
                            ...
                            <?php if ($nilaiMapel) {
                                $totalNilai += $nilaiMapel['akhir'];
                                $jumlahKelompok[$kode] += $nilaiMapel['akhir'];
                                $totalMapel++;
                            } ?>
                        <?php endforeach; ?>
                        <tr>
    ...
    <a href="<?= base_url('guru/raport/preview/' . $siswa['nis']) ?>" class="btn btn-info" target="_blank"><i class="fas fa-eye"></i> Preview e-Raport</a>
    <a href="<?= base_url('guru/raport/cetak/' . $siswa['nis']) ?>" class="btn btn-danger" target="_blank"><i class="fas fa-file-pdf"></i> Cetak PDF</a>
    <a href="<?= base_url('guru/raport/siswa/' . $kelas['kd_kelas']) ?>" class="btn btn-secondary">Kembali ke Daftar Siswa</a>
</div>
<?= $this->endSection() ?>