                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    <?php if ($m['file']): ?>
                                                        <a href="<?= base_url('guru/materitugas/download/' . $m['kd_materi']) ?>"
                                                            class="btn btn-sm btn-outline-primary" title="Download">
                                                            <i class="fas fa-download"></i>
                                                        </a>
                                                    <?php endif; ?>
                                                    <a href="<?= base_url('guru/materitugas/editMateri/' . $m['kd_materi']) ?>"
                                                        class="btn btn-sm btn-outline-warning" title="Edit">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <a href="<?= base_url('guru/materitugas/deleteMateri/' . $m['kd_materi']) ?>"
