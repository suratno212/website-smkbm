...
<div class="container mt-4">
    ...
    <?php endif; ?>
    <form action="<?= base_url('guru/materitugas/materiStore') ?>" method="post" enctype="multipart/form-data" class="mt-3">
        <?= csrf_field() ?>
        <div class="mb-3">
        ...
        <button type="submit" class="btn btn-primary"><i class="fas fa-upload"></i> Upload Materi</button>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Show preview if there's already a value (e.g., after form validation error)
