            ...
            <div class="modern-card">
                ...
                <div class="card-body-modern">
                    <form method="get" class="row g-3">
                        <div class="col-md-3">
                            <label for="mapel_filter" class="form-label">Mata Pelajaran</label>
                            <select name="mapel_filter" id="mapel_filter" class="form-select">
                                <option value="">Semua Mata Pelajaran</option>
                                <?php foreach ($mapel_list ?? [] as $mapel): ?>
                                    <option value="<?= $mapel['id'] ?>" <?= $mapel_filter == $mapel['id'] ? 'selected' : '' ?>>
                                        <?= $mapel['nama_mapel'] ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="kelas_filter" id="kelas_filter" class="form-select">
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="status_filter" id="status_filter" class="form-select">
                                ...
                                <option value="Dikumpulkan" <?= $status_filter == 'Dikumpulkan' ? 'selected' : '' ?>>Dikumpulkan</option>
                                <option value="Belum dikumpulkan" <?= $status_filter == 'Belum dikumpulkan' ? 'selected' : '' ?>>Belum dikumpulkan</option>
