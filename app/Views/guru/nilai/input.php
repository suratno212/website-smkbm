                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <p class="text-muted mb-0">
                                Kelas: <strong><?= $kelas ? $kelas['nama_kelas'] : 'Tidak dipilih' ?></strong> |
                                Mata Pelajaran: <strong><?= $mapel ? $mapel['nama_mapel'] : 'Tidak dipilih' ?></strong> |
        ...
        <div class="col-md-3">
            <div class="card bg-primary text-white">
                <div class="card-body text-center">
                    ...
                    <h3 class="mb-0"><?= count($siswa_list) ?></h3>
                </div>
            </div>
        </div>
        <div class="col-md-3">
                ...
                <div class="card-body">
                    ...
                    <?php else : ?>
                        <form action="<?= base_url('guru/nilai/store') ?>" method="POST" id="nilaiForm">
                            <?= csrf_field() ?>
                            <input type="hidden" name="kd_kelas" value="<?= $selected_kelas ?>">
                            <input type="hidden" name="kd_mapel" value="<?= $mapel ? $mapel['kd_mapel'] : '' ?>">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <?php foreach ($siswa_list as $index => $siswa) : ?>
                                            <?php
                                            $existingNilai = $siswa['nilai'] ?? null;
                                            $uts = $existingNilai ? $existingNilai['nilai_uts'] : '';
                                            $uas = $existingNilai ? $existingNilai['nilai_uas'] : '';
                                            $tugas = $existingNilai ? $existingNilai['nilai_tugas'] : '';
                                            $akhir = $existingNilai ? $existingNilai['nilai_akhir'] : '';
                                            ?>
                                            <tr>
