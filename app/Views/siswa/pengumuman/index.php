            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="<?= base_url('siswa/pengumuman/jadwal-ujian') ?>" class="btn btn-danger btn-sm">
                        ...
                        <?php foreach ($pengumuman as $p) : ?>
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <?php if ($p['file']) : ?>
                                        <div class="mt-3">
                                            <a href="<?= base_url('siswa/pengumuman/download/' . $p['kd_pengumuman']) ?>" class="btn btn-success btn-sm">
