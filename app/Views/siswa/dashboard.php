        ...
        <div class="col-lg-4 col-md-6 mb-3">
            <div class="stats-card stats-card-primary">
                ...
                <div class="stats-content">
                    <h3 class="stats-number"><?= $siswa['nis'] ?? 'N/A' ?></h3>
                            ...
                            <?php foreach (array_slice($pengumuman, 0, 5) as $p) : ?>
                                <div class="announcement-item">
                                    ...
                                    <div class="announcement-actions">
                                        <?php if ($p['file']) : ?>
                                            <a href="<?= base_url('siswa/pengumuman/download/' . $p['kd_pengumuman']) ?>" class="btn-modern btn-modern-sm btn-modern-outline">
                ...
                <div class="card-header-modern">
                    <div class="header-content">
                        ...
                        <div class="header-text">
                            ...
                            <p class="header-subtitle">Status pengumpulan tugas Anda</p>
                        </div>
                    </div>
                    <div class="header-action">
                        <a href="<?= base_url('siswa/materitugas') ?>" class="btn-modern btn-modern-primary">
                            <i class="fas fa-arrow-right"></i>
                        </a>
                    </div>
                </div>
                <div class="card-body-modern">
                    <?php if (empty($tugas_list)) : ?>
                        <div class="empty-state">
                            ...
                            <p class="empty-subtitle">Tugas dari guru akan muncul di sini</p>
                        </div>
                    <?php else : ?>
                        <div class="task-list">
                            <?php foreach ($tugas_list as $tugas) : ?>
                                <div class="task-item">
                                    <div class="task-badge">
                                        <span class="badge-modern badge-<?= $tugas['is_overdue'] ? 'danger' : 'warning' ?>">
                                            <?= $tugas['nama_mapel'] ?>
                                        </span>
                                    </div>
                                    <div class="task-content">
                                        <h6 class="task-title"><?= $tugas['judul'] ?></h6>
                                        <?php if ($tugas['deskripsi']) : ?>
                                            <p class="task-text"><?= strlen($tugas['deskripsi']) > 100 ? substr($tugas['deskripsi'], 0, 100) . '...' : $tugas['deskripsi'] ?></p>
                                        <?php endif; ?>
                                        <div class="task-meta">
                                            <span class="meta-item">
                                    ...
                                    <div class="task-status">
                                        <?php if ($tugas['status_pengumpulan'] == 'dikumpulkan') : ?>
                                            <span class="status-badge status-success">
                                                <i class="fas fa-check-circle"></i>
                                                Sudah Dikumpulkan
                                            </span>
                                        <?php elseif ($tugas['is_overdue']) : ?>
                                    ...
                                    <div class="task-actions">
                                        <a href="<?= base_url('siswa/materitugas/detailTugas/' . $tugas['kd_tugas']) ?>" class="btn-modern btn-modern-sm btn-modern-outline">
