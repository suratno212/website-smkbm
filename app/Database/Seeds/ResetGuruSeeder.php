...
class ResetGuruSeeder extends Seeder
{
    public function run()
    {
        ...
        $data = [
            [
                'user_id' => 2,
                'nik_nip' => '198001012010011001',
                'nama' => 'Ahmad Supriadi',
                'jenis_kelamin' => 'Laki-laki',
                'tempat_lahir' => 'Jakarta',
                'tanggal_lahir' => '1980-01-01',
                'agama' => 'Islam',
                'kd_mapel' => 1, // Matematika
                'alamat' => 'Jl. Ahmad No. 1, Jakarta',
                'no_hp' => '081234567890'
            ],
            [
                'user_id' => 3,
                'nik_nip' => '198502152010012002',
                'nama' => 'Siti Nurhaliza',
                'jenis_kelamin' => 'Perempuan',
                'tempat_lahir' => 'Bandung',
                'tanggal_lahir' => '1985-02-15',
                'agama' => 'Islam',
                'kd_mapel' => 2, // Bahasa Indonesia
                'alamat' => 'Jl. Siti No. 2, Bandung',
                'no_hp' => '081234567891'
            ],
            [
                'user_id' => 4,
                'nik_nip' => '198803201010013003',
                'nama' => 'Budi Santoso',
                'jenis_kelamin' => 'Laki-laki',
                'tempat_lahir' => 'Surabaya',
                'tanggal_lahir' => '1988-03-20',
                'agama' => 'Islam',
                'kd_mapel' => 3, // Bahasa Inggris
                'alamat' => 'Jl. Budi No. 3, Surabaya',
                'no_hp' => '081234567892'
            ],
            [
                'user_id' => 5,
                'nik_nip' => '199004101010014004',
                'nama' => 'Rina Marlina',
                'jenis_kelamin' => 'Perempuan',
