...
class PpdbModel extends Model
{
    ...
    protected $allowedFields = [
        'no_pendaftaran', 'nama_lengkap', 'jenis_kelamin', 'tempat_lahir', 
        'tanggal_lahir', 'agama', 'alamat', 'asal_sekolah', 'nama_ortu', 
        'no_hp_ortu', 'email', 'no_hp', 'jurusan_pilihan', 'status_pendaftaran', 'catatan'
    ];
    ...
    // Get PPDB dengan filter
    public function getPpdbWithFilter($filters = [])
    {
        $builder = $this->select('*');
